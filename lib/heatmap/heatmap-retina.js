...
(function(w){
    ...
    heatmap.prototype = {
        configure: function(config){
                ...
                me.set("width", config.width || (config.retina)?512:256);
                me.set("height", config.height || (config.retina)?512:256);
                me.set("debug", config.debug);
                me.set("retina", config.retina);
        ...
        init: function(){
				...
				if ( me.get("retina") ){
					...
					acanvas.width = acanvas.height = 512;
				}
                ...
                me.resize();
                canvas.style.cssText = acanvas.style.cssText = "position:absolute;top:0;left:0;z-index:10000000; width:256px; height:256px;";
